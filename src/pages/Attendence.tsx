...
import { getAttendebnce } from "@/store/attendenceSlice";
...
const Attendence = () => {
  ...
  const { attendence } = useSelector((state: RootStore) => state.attendence);
  ...
  useEffect(() => {
    ...
    dispatch(getAttendebnce(payload));
  ...
  const handleDateChange = (date: any) => {
    ...
    dispatch(getAttendebnce(payload1));
  };
            ...
            <div className="inputData ms-4">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  // dispatch(getAttendExpert(payload)); 
                }}
              >
