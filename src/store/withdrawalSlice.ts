...
export const getWithdrawalRequest: any = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    return await apiInstanceFetch.get(`admin/withdrawRequest/getAll?status=${payload}`);
  }
);
...
export const withdrawRequestPayUpdate: any = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    return await apiInstance.patch(`admin/withdrawRequest/pay?requestId=${payload}`);
  }
);
...
export const withdrawRequestDeclineUpdate: any = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    debugger
    return await apiInstance.patch(`admin/withdrawRequest/decline?requestId=${payload?.id}&reason=${payload?.reason}`);
  }
);
